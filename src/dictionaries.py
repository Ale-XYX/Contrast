...
LEVELS = {
    ...
    4: ['Pillars', 0, False, [
            ...
            "XXXXXXXXXXXXXCBBBAAAAAAACBBXXXXXXXXXXXXX",
            "XXXXXXXXXXXXXAXXXAXXXXXXCXXXXXXXHXXXXXXX",
            "XXXXXMXXXXXXXAXXXAXXXXXXCAAXXXXXCXXXJXXX",
            "XXXXXCXXXXXXXAXXXAXXXXXXCXXXFXXXCXXAAAXX",
            "XXXXXCXXXXXCCCCCCAXXXXXXCXXXBBBBCXXXXXXX",
    ...
    5: ['An Unintended Solution', 255, True, [
            ...
            "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX",
            "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX",
            "XXXXAAAAXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX",
            "XXXXEEEEXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX",
            "XXXXXXXXXXFFFHXXXXXXXXXXXXXXXXXXXXXXXXXX",
            "XXXXXXXXBBBBBCXXXXXXXXXXXXXXXXXXXXXXXXXX",
            "AAAAXXXXXXXXXCXXXXXXXXXXXXXXXXXXXXXXXXXX",
            "XXXXXXXXXXXHHCXXXXXCXXXXXXXXXXBXXXXXXXXX",
            "XXXXXXXXXCCCCCXXXXXCXXXXXHXXXXBXXXXXXXXX",
            "XXXXXXXXXXXXXCFFFFFCXXXXXCXXXXBXXXXXXXXX",
            "BBBBXXXXXXXXXCBBBBBCAAAAACBBBBBXXXXXAAAA",
            "XXXXXXXXXXXXXCXXKXXCXXJXXCXXXXXXXXXXXXXX",
            "XXXXXXXXXXXXXCCCCCCCCCCCCCXXXXXXXXXXXXXX",
